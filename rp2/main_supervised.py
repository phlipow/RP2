...
from treinamento import get_svm, get_rf

def run_model_supervised(num_chars):
    #----------- Trata os dados ----------------
    ...
    best_svm_model = get_svm(X_train_full, y_train_full)
    best_rf_model = get_rf(X_train_full, y_train_full)
