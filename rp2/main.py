...
print(f"Usando dados desde o ano de {min_year}")
...
print("\n--- Encontrando o melhor threshold para o SVM ---")
best_threshold_svm = find_best_threshold(best_svm_model, X_train_full, y_train_full)
print(f"Melhor threshold para SVM: {best_threshold_svm:.4f}")

print("\n--- Encontrando o melhor threshold para o Random Forest ---")
...
print(f"\nF1-Score SVM com threshold otimizado: {f1_svm:.4f}")
print(f"F1-Score RandomForest com threshold otimizado: {f1_rf:.4f}")
